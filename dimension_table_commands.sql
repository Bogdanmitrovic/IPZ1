...
CREATE SEQUENCE GROUP_DIM_S;

CREATE OR REPLACE TRIGGER GROUP_DIM_ON_INSERT
    BEFORE INSERT ON GROUP_DIM
    FOR EACH ROW
    BEGIN
        SELECT GROUP_DIM_S.NEXTVAL
        INTO :NEW.GROUP_DIM_ID
        FROM DUAL;
    END;
/
...
ALTER TABLE ENCOUNTER_DIM ADD FOREIGN KEY (GROUP_DIM_ID) REFERENCES GROUP_DIM(GROUP_DIM_ID);
...
ALTER TABLE AFGHAN_DIM ADD VALID_UNTIL DATE;
ALTER TABLE LOCATION_DIM ADD VALID_UNTIL DATE;
ALTER TABLE MILITARY_PERSONNEL_DIM ADD VALID_UNTIL DATE;
ALTER TABLE ORGANIZATION_DIM ADD VALID_UNTIL DATE;
ALTER TABLE MILITARY_UNIT_DIM ADD VALID_UNTIL DATE;